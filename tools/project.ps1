...
#
# The version is read out of turbo_tracker.py rather than repeated here, so
...
$sourcePath = Join-Path $ProjectRoot "turbo_tracker.py"
...
$ProjectName      = "Turbo Tracker"
$ProjectExeName   = "TurboTracker"
...
$ProjectUrl       = "https://github.com/sirawitbm/dota2-turbo-tracker"
